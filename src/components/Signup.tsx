                    ...
                    <form className='tw-p-[16px] tw-max-w-[432px] tw-w-full' onSubmit={handleSubmit(signup)}>
                        <div className='tw-flex tw-flex-col tw-gap-4'>
                            <div className='tw-flex signup-md:tw-justify-between tw-flex-wrap tw-justify-center signup-md:tw-gap-1 tw-gap-3'>
                                <input type="text" required placeholder='First name' className='tw-w-full tw-rounded tw-border-[1px] tw-border-[#D0D3D8] tw-outline-none tw-bg-[#F5F6F7] signup-md:tw-max-w-[194px] tw-p-[11px] tw-h-[40px]'
                                    {...register("firstName", { required: true })} />
                                <input type="text" required placeholder='Last name' className='tw-w-full tw-rounded tw-border-[1px] tw-border-[#D0D3D8] tw-outline-none tw-bg-[#F5F6F7] signup-md:tw-max-w-[194px] tw-p-[11px] tw-h-[40px]'
                                    {...register("lastName", { required: true })} />
                            </div>
                            <input type='email' required placeholder='Email' className='tw-w-full tw-rounded tw-border-[1px] tw-border-[#D0D3D8] tw-outline-none tw-bg-[#F5F6F7] tw-max-w-[399px] tw-p-[11px] tw-h-[40px]'
                                {...register("email", { required: true })} />
                            <input type='password' required placeholder='New Password' className='tw-w-full tw-rounded tw-border-[1px] tw-border-[#D0D3D8] tw-outline-none tw-bg-[#F5F6F7] tw-max-w-[399px] tw-p-[11px] tw-h-[40px]'
                                {...register("password", { required: true })} />
                            <input type='password' required placeholder='Confirm Password' className='tw-w-full tw-rounded tw-border-[1px] tw-border-[#D0D3D8] tw-outline-none tw-bg-[#F5F6F7] tw-max-w-[399px] tw-p-[11px] tw-h-[40px]'
                            ...
                            <div className='tw-flex tw-flex-col'>
                                ...
                                <div className='tw-flex signup-sm:tw-justify-between tw-flex-wrap tw-gap-1 tw-justify-center'>
                                    ...
                                    <div className='tw-flex tw-justify-between tw-max-w-[128.28px] tw-w-full tw-border-[1px] tw-rounded tw-px-3 tw-py-2'>
                                        ...
                                        <input type="radio" id='custom' value="C" {...register("gender", { required: true })} />
                                    </div>
                                </div>
                            </div>
