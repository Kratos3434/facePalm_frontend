...
const Signup = ({ isVisible }: { isVisible: any }) => {
    ...
    return (
        <Modal className='tw-flex tw-flex-col tw-justify-center tw-items-center tw-h-[100vh]'>
            <div className="tw-rounded-xl tw-shadow-md tw-bg-white tw-max-w-[432px] tw-w-full">
